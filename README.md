# Projet OSRévolution
*Projet réalisé dans le cadre du concours "La Nuit de l'info", édition 2025, par des étudiants à l'IUT de Sorbonne Paris Nord*

Bienvneue sur le dépôt du projet OSRévolution, un site réalisé en python avec le framework Flask dont l'objectif avec le collecitf [NIRD](https://nird.forge.apps.education.fr/) est d’encourager la contribution, de faire la promotion du collectif NIRD sous toutes ses formes, faciliter la contribution au sein de la communauté et à l’extérieur, mettre envaleur les solutions proposées par la démarche NIRD, etc...  
Nous étions une équipe de 20 dont des première, deuxième et troisième année de BUT Informatique et de BUT Science des données.
...
- Une easter egg avec un bouton "impossible" à cliquer
- Un jeu snake caché dans le site
...
#### Outils utilisés:
- framework Flask en Python
- Vscode avec l'extension Liveshare pour travailler sur le même projet en même temps
- Git et Github, surtout pour sauvegarder les versions
...
- Peut-être utiliser d'autres outils pour simplifier le développement frontend
- S'inspirer davantage de sites existant en cohérence avec le projet
- Avoir un membre de l'équipe uniquement en "Recherche et développement" dont l'objectif est de trouver des outils et des solutions dès la première étape du projet (À qui on transmettrait les problématique pour qu'il trouve une solution à l'aide d'internet par exemple)
- Trouver une stratégie fonctionnelle pour le déploiement à l'avance. Plus qu'une heure avant la fin (notamment par le chargé de "recherche et développement")
- Répartition des tâches plus claire avec la notion de rôles / spécialisations
- Penser à créer le dépôt git local dès le début et publier régulièrement les avancement dans le code
